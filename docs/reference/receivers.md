...
For more information on the wiring and setup see [this document](../assets/files/jeti-ex-bus-setup.pdf).
...
[Failsafe](../configurator/tabs/failsafe.md) for what does, and what does not, happen next.
