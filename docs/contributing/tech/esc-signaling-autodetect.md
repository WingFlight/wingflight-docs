...
Same mechanism as [RX serial wiring auto-detect](rx-wiring-autodetect.md),
...
- **No `inverted` bit.** `escSensorInit()` ([esc_sensor.c:4471](https://github.com/WingFlight/wingflight-firmware/blob/master/src/main/sensors/esc_sensor.c#L4471))
