...
This page describes how the SmartFuel estimator works and how it is wired into telemetry and MSP. For setting it up from the Configurator, see the [Power tab](../../configurator/tabs/power.md#smartfuel).
